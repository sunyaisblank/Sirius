...
4. Source files take descriptive snake_case names. The `[Domain][Category][Sequence][Variant]` codename scheme documented in the pre-rebuild README is superseded by the owner's adoption of a Google-style base. The retired mapping remains in Git (`git show 9e20150:docs/ARCHITECTURE.md`) for historical traceability.
