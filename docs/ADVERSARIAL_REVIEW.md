...
| Pull-request integration | GOVERNED NON-RENDER PATH PRESENT | Linux, Windows, and macOS jobs compile the complete strict product/test topology and execute exactly nine authority controls without creating a Mandatory receipt; this path cannot emit attestation evidence and cannot be promoted into qualification. |
