...
| P2900/P2996, P1–P6/E1–E4, and external-profile boundaries were prose-only at runtime | C++26 mode could be mistaken for native contracts/reflection and installed volumes carried no complete acceptance ledger | Fixed: compile-time language facts distinguish native features from checked-macro/explicit-schema substitutes; all ten P/E criteria, 23 dimensions, and 26 capability contracts are build-gated, installed, readiness-required, and exposed by `info capabilities` |
...
The same ledger now contains 26 explicit capability contracts. Each has one
...
- Install relocation, hostile-working-directory initialisation, and resource
  ...
  P/E criteria, 23 review dimensions, and 26 capability contracts. The final
