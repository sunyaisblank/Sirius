// GPU/CPU blackbody colour parity: the GPU Chebyshev approximation
// (legacy RDOP002A.cu, mirrored locally) against the CPU 32-sample CIE
// integration. Tolerance 25% per channel: the two methods differ fundamentally,
// so this tests colour direction, not exact match. Ported from TSSP003A.cpp;
// assertions and tolerances unchanged. Tests blackbody.h. LABEL: Correctness
