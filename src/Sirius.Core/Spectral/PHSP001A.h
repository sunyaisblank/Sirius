...
// Physical constants sourced from PHCN001A.h
constexpr double PLANCK_C1 = Constants::Physical::PLANCK_C1;
constexpr double PLANCK_C2 = Constants::Physical::PLANCK_C2;
