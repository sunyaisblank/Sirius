...
TEST_F(Vec4dTests, ParameterisedConstruction) {
    Sirius::Vec4d v(1.0, 2.0, 3.0, 4.0);
...
TEST_F(Vec4dTests, IndexedAccess) {
    Sirius::Vec4d v(10.0, 20.0, 30.0, 40.0);
...
TEST_F(Vec4dTests, Addition) {
    Sirius::Vec4d a(1.0, 2.0, 3.0, 4.0);
    Sirius::Vec4d b(0.5, 1.5, 2.5, 3.5);
    auto c = a + b;
...
TEST_F(Vec4dTests, Subtraction) {
    Sirius::Vec4d a(5.0, 4.0, 3.0, 2.0);
    Sirius::Vec4d b(1.0, 1.0, 1.0, 1.0);
    auto c = a - b;
...
TEST_F(Vec4dTests, CompoundAssignment) {
    Sirius::Vec4d v(1.0, 2.0, 3.0, 4.0);
    Sirius::Vec4d w(0.5, 0.5, 0.5, 0.5);
    v += w;
...
TEST_F(Vec4dTests, IsZero) {
    ...
    Sirius::Vec4d nonzero(0.0, 0.0, 0.0, 1e-20);
...
TEST_F(GeodesicStateDTests, ConstructionFromPosAndMom) {
    Sirius::Vec4d pos(0.0, 10.0, 1.5708, 0.0);
    Sirius::Vec4d mom(-1.0, 0.5, 0.0, 2.0);
    Sirius::GeodesicStateD g(pos, mom);
...
TEST_F(GeodesicStateDTests, ConservedQuantitiesSchwarzschildLike) {
    Sirius::Vec4d pos(0.0, 10.0, M_PI / 2.0, 0.0);
    Sirius::Vec4d mom(-0.9, 0.3, 0.0, 3.0);
    Sirius::GeodesicStateD g(pos, mom);
...
TEST_F(HamiltonianStateDTests, RoundTripViaGeodesicState) {
    Sirius::Vec4d q(0.0, 10.0, 1.5, 0.5);
    Sirius::Vec4d p(-1.0, 0.3, 0.1, 2.0);
    Sirius::HamiltonianStateD h(q, p);
...
TEST_F(HamiltonianStateDTests, ConstructFromGeodesicState) {
    Sirius::Vec4d pos(0.0, 8.0, 1.2, 0.8);
    Sirius::Vec4d mom(-0.5, 0.2, 0.0, 1.5);
    Sirius::GeodesicStateD geo(pos, mom);
    Sirius::HamiltonianStateD h(geo);
...
TEST_F(ConversionTests, ToVec4dFromFloats) {
    auto v = Sirius::toVec4d(1.0f, 2.0f, 3.0f, 4.0f);
    EXPECT_DOUBLE_EQ(v.t, 1.0);
    EXPECT_DOUBLE_EQ(v.r, 2.0);
}

TEST_F(ConversionTests, ToFloat4RoundTrip) {
    Sirius::Vec4d v(1.5, 2.5, 3.5, 4.5);
    float t, r, theta, phi;
    Sirius::toFloat4(v, t, r, theta, phi);
