...
set_tests_properties(
    CPUGPUParityTests.CPUBaselineSchwarzschildEscaping
    CPUGPUParityTests.CPUBaselineSchwarzschildHorizon
    CPUGPUParityTests.CPUBaselineKerrPrograde
    CPUGPUParityTests.ParityToleranceSpecification
    CPUGPUParityTests.ReferenceRayGridGeneration
    CPUGPUParityTests.ReferenceRaysCoverImpactParameters
...
set_tests_properties(
    EllisDrainholeTests.ThroatFactorPositive
    EllisDrainholeTests.ThroatMinimumRadius
    EllisDrainholeTests.ArealRadiusSymmetry
    EllisDrainholeTests.RedshiftFunctionNegative
    EllisDrainholeTests.RedshiftFunctionBounded
    EllisDrainholeTests.AsymptoticFlatness
    EllisDrainholeTests.ThroatSizeIncreases
    EllisDrainholeTests.NMustBeGreaterThanM
    PROPERTIES LABELS "Mandatory;Correctness"
)
...
set_tests_properties(
    ...
    FilmSimulationTest.GPUConversion_PreservesValues
    FilmSimulationTest.GPUConversion_FeatureFlags
...
set_tests_properties(
    GPUConservationTests.DebugBufferAnalysisWorks
    GPUConservationTests.DebugBufferConfigValid
    GPUConservationTests.SpecificationNullCondition
    GPUConservationTests.SpecificationEnergyConservation
    GPUConservationTests.SpecificationAngularMomentum
    GPUConservationTests.CUDANotAvailable
    PROPERTIES LABELS "Mandatory;Stability"
)
...
set_tests_properties(
    KerrSchildTests.KerrRadiusEquatorialPlane
    KerrSchildTests.KerrRadiusOnAxis
    KerrSchildTests.KerrRadiusSymmetry
    KerrSchildTests.NullVectorIsNull
    KerrSchildTests.NullVectorTimeComponent
    KerrSchildTests.AsymptoticFlatness
    KerrSchildTests.SchwarzschildLimit
    KerrSchildTests.MetricDiagonalPositiveDefiniteSpatial
    KerrSchildTests.MetricTimeComponentSign
    KerrSchildTests.OblateSpheroidalRelation
    PROPERTIES LABELS "Mandatory;Correctness"
)
...
set_tests_properties(
    SMBHParamsTest.ISCO_Schwarzschild
    SMBHParamsTest.ISCO_Extremal_Prograde
    SMBHParamsTest.ISCO_Extremal_Retrograde
    SMBHParamsTest.ISCO_Monotonic_In_Spin
    SMBHParamsTest.Horizon_Schwarzschild
    SMBHParamsTest.Horizon_Extremal
    SMBHParamsTest.InnerHorizon_Schwarzschild
    SMBHParamsTest.GravitationalRadius_Scaling
    SMBHParamsTest.EddingtonLuminosity_Scaling
    SMBHParamsTest.SpinClamped_To_ThorneLimitPositive
    SMBHParamsTest.SpinClamped_To_ThorneLimitNegative
    SMBHParamsTest.M87Star_Configuration
    SMBHParamsTest.SgrAStar_Configuration
    SMBHParamsTest.Gargantua_NearExtremal
    SMBHParamsTest.GPUConversion_PreservesValues
    SMBHParamsTest.AngularSize_InverseSqaureDistance
    PROPERTIES LABELS "Correctness"
)
...
set_tests_properties(
    TurbulenceTest.PerlinNoise_BoundedRange
    TurbulenceTest.PerlinNoise_Deterministic
    TurbulenceTest.PerlinNoise_DifferentSeeds
    TurbulenceTest.PerlinNoise_Continuous
    TurbulenceTest.FBm_BoundedRange
    TurbulenceTest.FBm_MoreOctaves_MoreDetail
    TurbulenceTest.DensityPerturbation_PositiveDefinite
    TurbulenceTest.DensityPerturbation_MeanNearUnity
    TurbulenceTest.DensityPerturbation_Disabled_ReturnsUnity
    TurbulenceTest.DensityPerturbation_ZeroAmplitude_ReturnsUnity
    TurbulenceTest.Validate_ClampsExponent
    TurbulenceTest.Validate_ClampsAmplitude
    TurbulenceTest.Validate_EnforcesScaleHierarchy
    TurbulenceTest.Validate_ClampsOctaves
    TurbulenceTest.GPUConversion_PreservesValues
    PROPERTIES LABELS "Correctness"
)
