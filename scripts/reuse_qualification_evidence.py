...
FIXED_ARTIFACTS = {
    ...
    "test-input-infinity_probe_spv": "test-input-infinity_probe_spv",
    "test-input-infinity_probe_fp32comp_spv": "test-input-infinity_probe_fp32comp_spv",
    "test-input-infinity_probe_fp64_spv": "test-input-infinity_probe_fp64_spv",
    "test-input-metric_consistency_probe_spv": "test-input-metric_consistency_probe_spv",
    "test-input-metric_consistency_probe_fp32comp_spv": "test-input-metric_consistency_probe_fp32comp_spv",
    "test-input-metric_consistency_probe_fp64_spv": "test-input-metric_consistency_probe_fp64_spv",
    "test-input-camera_frame_probe_spv": "test-input-camera_frame_probe_spv",
    "test-input-camera_frame_probe_fp32comp_spv": "test-input-camera_frame_probe_fp32comp_spv",
    "test-input-camera_frame_probe_fp64_spv": "test-input-camera_frame_probe_fp64_spv",
    "test-input-coupled_probe_fp64_spv": "test-input-coupled_probe_fp64_spv",
