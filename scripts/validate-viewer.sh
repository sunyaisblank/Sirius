...
for source_text in (
    ...
    str(root / "test-input-infinity_probe_spv"),
    str(root / "test-input-infinity_probe_fp32comp_spv"),
    str(root / "test-input-infinity_probe_fp64_spv"),
    str(root / "test-input-metric_consistency_probe_spv"),
    str(root / "test-input-metric_consistency_probe_fp32comp_spv"),
    str(root / "test-input-metric_consistency_probe_fp64_spv"),
    str(root / "test-input-camera_frame_probe_spv"),
    str(root / "test-input-camera_frame_probe_fp32comp_spv"),
    str(root / "test-input-camera_frame_probe_fp64_spv"),
    str(root / "test-input-coupled_probe_fp64_spv"),
